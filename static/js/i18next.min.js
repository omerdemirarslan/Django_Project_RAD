!function (t, e) {
    ...
    function o(t, e, o) {
        var r = n(t, e, Object), i = r.obj, a = r.k;
        i[a] = o
    }

    function r(t, e, o, r) {
        var i = n(t, e, Object), a = i.obj, s = i.k;
        a[s] = a[s] || [], r && (a[s] = a[s].concat(o)), r || a[s].push(o)
    }

    function i(t, e) {
        var o = n(t, e), r = o.obj, i = o.k;
        if (r) return r[i]
    }
    ...
    var x = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return w(n, t), n.prototype.changeLanguage = function (t) {
            ...
            void 0 === n && (n = ":");
            var o = e.keySeparator || this.options.keySeparator || ".", r = e.ns || this.options.defaultNS;
            if (n && t.indexOf(n) > -1) {
                var i = t.split(n);
            ...
            var n = e.keySeparator || this.options.keySeparator || ".", o = this.extractFromKey(t[t.length - 1], e),
                r = o.key, i = o.namespaces, a = i[i.length - 1], s = e.lng || this.language,
            ...
            var c = this.resolve(t, e), p = Object.prototype.toString.apply(c),
            ...
            if (c && "string" != typeof c && g.indexOf(p) < 0 && (!h || "[object Array]" !== p)) {
                ...
                if (e.keySeparator || this.options.keySeparator) {
                    ...
                    for (var v in c) d[v] = this.translate("" + r + n + v, k({}, e, {joinArrays: !1, ns: i}));
                    c = d
                }
            } else if (h && "[object Array]" === p) c = c.join(h), c && (c = this.extendTranslation(c, r, e)); else {
                var y = !1, b = !1;
                if (this.isValidLookup(c) || void 0 === e.defaultValue || (y = !0, c = e.defaultValue), this.isValidLookup(c) || (b = !0, c = r), b || y) {
                    ...
                    if ("fallback" === this.options.saveMissingTo && S && S[0]) for (var w = 0; w < S.length; w++) m.push(S[w]); else "all" === this.options.saveMissingTo ? m = this.languageUtils.toResolveHierarchy(e.lng || this.language) : m.push(e.lng || this.language);
            ...
            var i = n.postProcess || this.options.postProcess, a = "string" == typeof i ? [i] : i;
            ...
            return "string" == typeof t && (t = [t]), t.forEach(function (t) {
                if (!e.isValidLookup(o)) {
                    var r = e.extractFromKey(t, n), i = r.key, a = r.namespaces;
        ...
        return t.prototype.getScriptPartFromCode = function (t) {
            ...
            var n = this, o = this.getFallbackCodes(e || this.options.fallbackLng || [], t), r = [], i = function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
        ...
        nr: [2, 1],
        fc: 2
    }, {lngs: ["ro"], nr: [1, 2, 20], fc: 20}, {lngs: ["sl"], nr: [5, 1, 2, 3], fc: 21}], H = {
        1: function (t) {
            return Number(t > 1)
        }, 2: function (t) {
            return Number(1 != t)
        ...
        return e.prototype.init = function () {
            ...
            e && (this.options = t, this.format = t.interpolation && t.interpolation.format || function (t) {
                return t
            }, this.escape = t.interpolation && t.interpolation.escape || l), t.interpolation || (t.interpolation = {escapeValue: !0});
            ...
            var a = this, s = void 0, l = void 0, u = function (t) {
                if (t.indexOf(a.formatSeparator) < 0) return i(n, t);
                var e = t.split(a.formatSeparator), r = e.shift().trim(), s = e.join(a.formatSeparator).trim();
        ...
        return w(e, t), e.prototype.queueLoad = function (t, e, n) {
            ...
            var o = this, i = t.split("|"), a = O(i, 2), s = a[0], l = a[1];
            ...
            if (r.allowMultiLoading && this.backend.readMulti) this.read(a.toLoadLanguages, a.toLoadNamespaces, "readMulti", null, null, function (t, e) {
                t && o.logger.warn("loading namespaces " + a.toLoadNamespaces.join(", ") + " for languages " + a.toLoadLanguages.join(", ") + " via multiloading failed", t), !t && e && o.logger.log("loaded namespaces " + a.toLoadNamespaces.join(", ") + " for languages " + a.toLoadLanguages.join(", ") + " via multiloading", e), a.toLoad.forEach(function (n) {
                    var r = n.split("|"), a = O(r, 2), s = a[0], l = a[1], u = i(e, [s, l]);
                    if (u) o.loaded(n, t, u); else {
                ...
                var s = function (t) {
                    var e = this, n = t.split("|"), o = O(n, 2), r = o[0], i = o[1];
        ...
        return w(e, t), e.prototype.load = function (t, e, n) {
            ...
            "string" == typeof t && (t = this.services.languageUtils.toResolveHierarchy(t)), "string" == typeof e && (e = [e]), r.enabled ? this.cache.load(t, function (e, r) {
                if (e && o.logger.error("loading languages " + t.join(", ") + " from cache failed", e), r) for (var i in r) for (var a in r[i]) if ("i18nStamp" !== a) {
                    var s = r[i][a];
        ...
        function e() {
            ...
            S(this, e);
            var r = L(this, t.call(this));
            return r.options = b(n), r.services = {}, r.logger = C, r.modules = {external: []}, !o || r.isInitialized || n.isClone || r.init(n, o), r
        }
        ...
        return w(e, t), e.prototype.init = function (t, e) {
            ...
            var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : m;
            ...
            var n = this, o = function t(e) {
                var o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = k({}, o);
            ...
            var t = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                ...
                r = k({}, n, this.options, {isClone: !0}), i = new e(r, o), a = ["store", "services", "language"];
            return a.forEach(function (e) {
                i[e] = t[e]
